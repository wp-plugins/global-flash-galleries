			...
			if ($images !== false)
			{
				...
				foreach ($images as $img)
				{
					...
					if ( $img->width > $maxImageWidth || $img->height > $maxImageHeight )
					{
						...
						$img->source = $func->url($image->resized(array(
							'width' => $this->width > $maxImageWidth ? $maxImageWidth : $this->width,
							'height' => $this->height > $maxImageHeight ? $maxImageHeight : $this->height
						)));
					}
