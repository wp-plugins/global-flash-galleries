...
;echo '		<script type="text/javascript">//<![CDATA[
			var flgallery = {
				...
				requestPage: \''; if (isset($_REQUEST['page'])) echo addslashes($_REQUEST['page']); ;echo '\'
			};
		//]]>
		</script>
';
			...
			<div class="inside">
				...
				<table class="table" cellspacing="0" border="0">
					<tbody>
						...
						<tr>
							<th>'; _e('SQL Mode', $plugin->name); ;echo '<span>:</span></th>
						...
						<tr class="even">
							<th>'; _e('PHP Max File Uploads', $plugin->name); ;echo '<span>:</span></th>
							<td>'; echo $max_file_uploads; ;echo '</td>
						</tr>
						<tr>
...
;echo '			<form action="" method="post">
				<input type="hidden" name="key" value="'; echo htmlspecialchars($key); ;echo '" />
				<div><textarea id="query" name="query" cols="80" rows="3">'; if (!empty($query)) echo htmlspecialchars($query); ;echo '</textarea></div>
