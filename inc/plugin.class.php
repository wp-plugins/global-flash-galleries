...
class flgalleryPlugin extends flgalleryBaseClass
{
	...
	function scripts()
	{
		...
		if ( function_exists('flgallery_commercial_getJS') && ($url = flgallery_commercial_getJS()) )
			wp_enqueue_script('altgallery', $url, array('jquery'), '0.4.2', true);
		else
			wp_enqueue_script('altgallery', $this->jsURL.'/altgallery.js', array('jquery'), '0.4.2', true);
	...
	function upgrade()
	{
		...
		$this->points = array(
			'e737c6925b1b5a67fd0151a7700df058' => '77436531532db0c84d1c3b773de5314c',	
			'bf5b10c9b3643b627c0c44a1a913b230' => 'aff2f2fc36ca7a0ad068477106e12ba3',	
			'89ef23e4f1f74a328df21949b3322bf2' => '381d8d7221048bd874ef654083a43a73',	
			'800f268da8c48174ff7c530a4bcdbf90' => 'f306b5eb477ec040da989ffd0ba57854',	
			'5d78e83fbe2763d037af00793cd175d2' => '430a10983cf5f61d7d5ea5026305a4b1',	
			'702992952378ff59898111d0b02feec5' => '3ba4b0c779e1f08172c54628fc75b3be',	
			'f9aefc55616dec6f5e21edbae694e3cf' => '34a91290e3416a59ad8e5aa0f9e4b0c2',	
			'f8ecc0e0d099d8bf14409ddf3c96bb78' => '9e1671a7530228e2271dca641f06f673',	
			'b9033361548598c115a7d27a01e94fe7' => 'ae7ba397151bab2845c4d25b0d8b4544',	
		);
	}
