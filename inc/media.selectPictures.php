...
';
	foreach ($albums as $album)
	{
		...
		if ($imagesCount)
		{
;echo '	<li class="select-album" id="select-album-'; echo $album->id; ;echo '" style="clear:left; margin:15px 0 20px;">
		...
		<ul id="select-album-'; echo $album->id; ;echo '-images" style="margin:5px 5px 10px; display:none;"></ul>
