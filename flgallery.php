...
Description: In this plugin we joined several galleries that can be operated from a single shell. You can upload photos and use them in several galleries simultaneously. You can adjust the galleries' settings and publish them in your posts.
Version: 0.7.9
Author: Flash Gallery Team
Author URI: http://flash-gallery.com/
*/

define( 'FLGALLERY_VERSION',	'0.7.9' );
...
define( 'FLGALLERY_HREF', str_replace('%7E', '~', FLGALLERY_URL_SCHEME.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].(empty($_REQUEST['page']) ? '' : '?page='.$_REQUEST['page'])) );


define( 'FLGALLERY_SITE_DIR', rtrim(ABSPATH, '/') );
